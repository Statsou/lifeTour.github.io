...
var _swiperSettings = require("./utils/swiper-settings");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _swiperSettings.swiperSettings)();
  (0, _map.maps)();
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./utils/ios-vh-fix":13,"./utils/map":14,"./utils/menu":15,"./utils/play-video":16,"./utils/swiper-settings":18}],2:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":11,"../../utils/scroll-lock":17}],11:[function(require,module,exports){
"use strict";
...
var maps = function maps() {
  ...
  var mapInitial = function mapInitial() {
    var mapOptions = {
    ...
    var layer = new L.TileLayer('https://api.maptiler.com/maps/streets-v2/{z}/{x}/{y}.png?key=StFld3NCrvag1TMtL9m1');
    map.addLayer(layer);
    var marker = L.marker({
      lat: 55.774864204309026,
      lng: 37.6326414970373
    }, markerOptions);
    marker.addTo(map);
  };
  mapInitial();
...
var menu = function menu() {
  ...
  var mainHeaderContainer = mainHeader.querySelector('.main-header__container');
  var navigation = mainHeaderContainer.querySelector('.main-header__navigation');
  var navToggle = mainHeaderContainer.querySelector('.main-header__navigation-button');
  var menuList = mainHeaderContainer.querySelector('.main-header__menu-list');
  function menuActiveInitital() {
    if (breakpoint.matches && document.querySelector('.main-header') && document.querySelector('.main-header__container') && document.querySelector('.main-header__navigation') && document.querySelector('.main-header__navigation-button') && document.querySelector('.main-header__menu-list')) {
...
var playVideo = function playVideo() {
  if (document.querySelector('.video__preview') && document.querySelector('.video__button-play') && document.getElementById('video')) {
    ...
    var buttonPlay = videoPreview.querySelector('.video__button-play');
...
},{"./ios-checker":12}],18:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.swiperSettings = void 0;
var swiperSettings = function swiperSettings() {
  ...
  var swiperTraining = new Swiper('.swiper-training', {
    loop: false,
    watchSlidesVisibility: true,
    watchSlidesProgress: false,
    slidesPerView: 1,
  ...
  var swipeGallery = new Swiper('.swiper-gallery', {
    loop: false,
    watchSlidesVisibility: true,
    watchSlidesProgress: false,
    slidesPerView: 'auto',
...
exports.swiperSettings = swiperSettings;
